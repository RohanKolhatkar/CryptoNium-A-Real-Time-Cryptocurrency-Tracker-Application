...
const Homepage = () => {
  ...
  return (
    <>
      <Title level = {1} className='heading' style = {{color: '#2C196C'}} ><center>GLOBAL CRYPTOCURRENCIES DATA - BY CRYPTONIUM</center></Title>
      {/* // adding rows */}
      <Row>
        ...
        <Col span = {12}><Statistic title = "Total volume of 24 hours" value = {millify(globalStats.total24hVolume)}/> </Col>
